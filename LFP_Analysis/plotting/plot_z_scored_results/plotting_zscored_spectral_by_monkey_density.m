...
dir_in_zscored = 'E:\Output\GINO\zscored_stats\optic_flow_density\';
dir_main_out = 'E:\Output\GINO\Figures\z_scored_spectral\optic_flow_density\'; % root directory for the output
p_th = 0.05;
iterations = 5000;
Events = ["target","move","stop"];

for monkey = ["Bruno","Schro"]
    ...
    load(strcat(dir_in_zscored_pth,sprintf('zscored_stats_%s_p_th_%.2f_iter_%d_all_events_density.mat',monkey,p_th,iterations)));

...
dir_main = 'E:\Output\GINO\Figures\avg_results_freq_vs_time\optic_flow_density\'; % root directory for the output
Events = ["target","move","stop"];
show_fig = 1;

for monkey = ["Quigley","Schro"]

    dir_out = strcat(dir_main,sprintf('%s\\',monkey));
        
    % load test-statistics
    load(strcat(dir_in,sprintf('test_stats_%s_all_events_density.mat',monkey)),'t_stats');
    % plot and save figures
    plot_spectral_features_density(t_stats,Events,monkey,show_fig,dir_out)
    clear t_stats

...
Z_spec_theta_cc = z_spec_cluster_corrected(z_log_norwd,clust_th); % cluster correction of the test-statistics
Zscored_stats.region.(reg).event.(EventType).var.(quantity).z_log_norwd_corr = Z_spec_theta_cc; % z-scored spectrogram cluster-corrected

...
filename_null = sprintf('_iter_%d',iterations);
...
save(strcat(dir_out_null,sprintf('pseudo_stats_%s%s.mat',monkey,filename_null)),'pseudo_stats','-v7.3');

disp(['Saving...'])
save(strcat(dir_out_null,sprintf('null_stats_%s.mat',monkey)),'null_stats','-v7.3');
save(strcat(dir_out_test,sprintf('zscored_stats_%s.mat',monkey)),'Zscored_stats','-v7.3');

...
function [clust_w_psd_list,clust_w_spec_list,clust_w_list_theta,clust_w_list_beta] = max_cluster_count_null_distribution(z_psd_diff_mat,z_spec_diff_mat,z_theta_diff_mat,z_beta_diff_mat,Niter)

...
dir_out_null = 'E:\Output\GINO\pseudo_stats\optic_flow_density\';
...
load(strcat(dir_in_null,sprintf('%s\\pseudo_stats_%s_iter_%d_ID_1_all_events_density.mat',monkey,monkey,iter)));
...
for animal = monkey
    ...
    for ID = 1:max_ID
        ...
        load(strcat(dir_in_null,sprintf('%s\\pseudo_stats_%s_iter_%d_ID_%d_all_events_density.mat',animal,animal,iter,ID)));
...
save(strcat(dir_out_null,sprintf('pseudo_avg_%s_tot_iter_%d_all_events_density.mat',monkey,max_ID*iter)),'pseudo_avg','-v7.3');

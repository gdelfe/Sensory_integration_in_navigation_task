...
function [] = merge_server_structures_on_server(monkey)
...
dir_in_null = '/scratch/gd2112/GINO_CODES/Output/pseudo_stats/';
dir_out_null = '/scratch/gd2112/GINO_CODES/Output/pseudo_stats/';

...
stats = spectral_features_monkey_density_R_NR(experiments,Events,sess_range,ts_start,ts_stop,W,f_max,Nt,Wt,dnt);
...
save(strcat(dir_out,sprintf('stats_%s_all_events_R_NR_density.mat',monkey)),'stats','-v7.3');

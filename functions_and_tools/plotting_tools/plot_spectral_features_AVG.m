...
[m, ymax] = min(abs(f_spec-50)); % find the index of max f_spec at 50 Hz
% region names
...
%         ylim([0 ymax])
%         
%         fname = strcat(dir_out_region,sprintf('RWD_spec_reg_%s_event_%s.pdf',reg,EventType));
%         saveas(fig,fname)
